...
(function(){
  angular.module("dsc").controller("armorFinderController", function($q, $scope, storageSvc, itemSvc, armorFinderSvc, statSvc, uiGridConstants){
    ...
    $scope.modifierNames = ["Physical", "Magic", "Fire", "Lightning", "Bleed", "Poison", "Curse", "Poise"];
    $scope.typeNames = {
      0: 'head',
      1: 'chest',
      2: 'hands',
    ...
    $scope.calculate = function(type){
      var x$, ref$, ref1$, i$, len$, index, name;
      ...
      ((ref$ = (ref1$ = armorFinderSvc.params).modifiers || (ref1$.modifiers = {})).def || (ref$.def = [])).length = 0;
      for (i$ = 0, len$ = (ref$ = $scope.modifierNames).length; i$ < len$; ++i$) {
        index = i$;
        name = ref$[i$];
    ...
    $scope.$watch("params", function(){
      ...
      $scope.favorRingBonus = $scope.params.havelRing
        ? (max + $scope.havelRingBonus) * 0.2
        : max * 0.2;
...
(function(){
  ...
  ArmorFinderSvc = (function(){
    ...
    function ArmorFinderSvc(_inventorySvc, _itemSvc, $q){
      ...
      this.canAfford = bind$(this, 'canAfford', prototype);
    ...
    prototype.findBestCombinations = function(){
      ...
      return this.findUsableArmors().then(function(armors){
        ...
        if (this$.params.includeUpgrades) {
          ...
          start = new Date().getTime();
          return this$.calculateCombinationScores(combs).then(function(combs){
            var end, time;
            end = new Date().getTime();
            time = end - start;
            if (this$._debugLog) {
    ...
    prototype.findCombinationsWithUpgrades = function(armors){
      var start, staticArmors, dynamicArmors, combinations, end, time, this$ = this;
      start = new Date().getTime();
      staticArmors = armors;
    ...
    prototype.canAfford = function(comb){
      var this$ = this;
      return {
        having: function(inventory){
          ...
          for (i$ = 0, len$ = (ref$ = comb.armors).length; i$ < len$; ++i$) {
            ...
            for (j$ = 0, len1$ = (ref1$ = armor.totalCost).length; j$ < len1$; ++j$) {
              aCost = ref1$[j$];
              cCost = null;
              for (k$ = 0, len2$ = (ref2$ = comb.totalCost).length; k$ < len2$; ++k$) {
                x = ref2$[k$];
    ...
    prototype.calculateArmorScores = function(armors){
      var i$, len$, armor, j$, ref$, len1$, index, name, ref1$, ref2$;
      for (i$ = 0, len$ = armors.length; i$ < len$; ++i$) {
        ...
        armor.score = 0;
        armor.detailScores = {};
        for (j$ = 0, len1$ = (ref$ = this._itemSvc.constructor.DefenseTypes).length; j$ < len1$; ++j$) {
          index = j$;
          name = ref$[j$];
          armor.detailScores[name] = (ref1$ = armor.def[index]) != null ? ref1$ : 0;
          armor.score += ((ref1$ = armor.def[index]) != null ? ref1$ : 0) * ((ref1$ = ((ref2$ = this.params).modifiers || (ref2$.modifiers = {})).def[index]) != null ? ref1$ : 0);
        }
      }
      return armors;
    };
    prototype.calculateCombinationScores = function(combinations, limit, checkAffordability){
      var this$ = this;
      limit == null && (limit = this.params.resultLimit);
      checkAffordability == null && (checkAffordability = false);
      return this._inventorySvc.load().then(function(inventory){
        var best, i$, to$, a, comb, j$, to1$;
        best = [];
        for (i$ = 0, to$ = limit; i$ < to$; ++i$) {
          a = i$;
        ...
        for (i$ = limit, to$ = combinations.length; i$ < to$; ++i$) {
          ...
          comb = combinations.pop();
          comb.score = comb.armors[0].score + comb.armors[1].score + comb.armors[2].score + comb.armors[3].score;
          for (j$ = 0, to1$ = limit; j$ < to1$; ++j$) {
            a = j$;
            if (comb.score > best[a].score && (!checkAffordability || this$.canAfford(comb).having(inventory))) {
              best[a] = comb;
              break;
            }
          }
...
(function(){
  ...
  ItemServiceUpgradeComponent = (function(){
    ...
    prototype.apply = function(upgrade){
      ...
      return {
        to: function(item){
          var x$, i$, ref$, len$, index, value, ref1$;
          this$.ensureItCanBeUpgraded(
          item);
          x$ = item;
          x$.id += upgrade['id'] % 100;
          ...
          if (item.def != null) {
            for (i$ = 0, len$ = (ref$ = item.def).length; i$ < len$; ++i$) {
              index = i$;
              value = ref$[i$];
              item.def[index] *= (ref1$ = upgrade.defMod[index]) != null ? ref1$ : 1;
            }
          }
          ...
          case 'weapon':
            ...
            if (item.atk != null) {
              for (i$ = 0, len$ = (ref$ = item.atk).length; i$ < len$; ++i$) {
                index = i$;
                value = ref$[i$];
                item.atk[index] *= (ref1$ = upgrade.atkMod[index]) != null ? ref1$ : 1;
              }
            }
            if (item.bonus != null) {
              for (i$ = 0, len$ = (ref$ = item.bonus).length; i$ < len$; ++i$) {
                index = i$;
                value = ref$[i$];
                item.bonus[index] *= (ref1$ = upgrade.bonusMod[index]) != null ? ref1$ : 1;
              }
            }
            break;
          case 'armor':
            if (item.defPhy != null) {
              for (i$ = 0, len$ = (ref$ = item.defPhy).length; i$ < len$; ++i$) {
                index = i$;
                value = ref$[i$];
                item.defPhy[index] *= (ref1$ = upgrade.defPhyMod[index]) != null ? ref1$ : 1;
              }
            }
          }
          return item;
    ...
    module.exports = {
      'Item': ItemModel = (function(){
        ...
        prototype.useDataFrom = function(itemData){
          var i$, ref$, len$, key;
          import$(this, itemData);
          for (i$ = 0, len$ = (ref$ = ['def', 'dmgTypes', 'atk', 'req', 'atkCost', 'dmg', 'bonus', 'defPhy']).length; i$ < len$; ++i$) {
            key = ref$[i$];
            if (this[key] != null && itemData[key] != null) {
              this[key] = itemData[key].slice();
            }
          }
          return this;
        };
      ...
      'Weapon': WeaponModel = (function(superclass){
        ...
        Object.defineProperty(prototype, 'dpsPhy', {
          get: function(){
            return this._dpsFor(this.atk[0]);
          },
          configurable: true,
          enumerable: true
        });
        Object.defineProperty(prototype, 'dpsMag', {
          get: function(){
            return this._dpsFor(this.atk[1]);
          },
          configurable: true,
          enumerable: true
        });
        Object.defineProperty(prototype, 'dpsFir', {
          get: function(){
            return this._dpsFor(this.atk[2]);
          },
          configurable: true,
          enumerable: true
        });
        Object.defineProperty(prototype, 'dpsLit', {
          get: function(){
            return this._dpsFor(this.atk[3]);
          },
          configurable: true,
          enumerable: true
        });
...
(function(){
  ...
  StatService = (function(){
    ...
    var ref$, prototype = StatService.prototype, constructor = StatService;
    StatService.allStats = ['vit', 'att', 'end', 'str', 'dex', 'res', 'int', 'fai', 'hum'];
    StatService.statNames = (ref$ = ['Vitality', 'Attunement', 'Endurance', 'Strength', 'Dexterity', 'Resistance', 'Intelligence', 'Faith', 'Humanity'], ref$['vit'] = 'Vitality', ref$['att'] = 'Attunement', ref$['end'] = 'Endurance', ref$['str'] = 'Strength', ref$['dex'] = 'Dexterity', ref$['res'] = 'Resistance', ref$['int'] = 'Intelligence', ref$['fai'] = 'Faith', ref$['hum'] = 'Humanity', ref$);
